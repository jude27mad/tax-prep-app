...
The estimator currently supports 2025 provincial tax for Ontario, British Columbia, Alberta, and Manitoba (Qu�bec handled separately). The wizard and API accept two-letter province codes (`province=ON`, `BC`, `AB`, `MB`); more provinces will be added in upcoming phases.
