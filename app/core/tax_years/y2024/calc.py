...
def compute_full_2024(
    ...
    on_tax = on_tax_on_taxable_income_2024(taxable_income)
    on_creds = on_credits_2024()
...
def compute_return(in_: ReturnInput) -> ReturnCalc:
    ...
    breakdown = compute_full_2024(taxable_income, income)
